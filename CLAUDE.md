...
- Próximos caminhos possíveis: V4 limpeza de peso morto somente com confirmação item a item; V5 consolidação de eventos; V6 reordenação da home; V7 unificação da navegação como alto risco e para depois; B3 mídia/performance por último. Follow-up separado: investigar Service Worker em localhost se voltar a interceptar Leaflet/OSM, sem tratar como regressão do V3.
