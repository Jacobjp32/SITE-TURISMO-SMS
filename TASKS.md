...
3. **Fase 2 — navegação e estrutura:** não iniciada; V7 permanece pendente no projeto atual, usando `js/nav-shared.js` como base única; V6 permanece pendente e deve ser reavaliado depois.
