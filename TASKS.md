...
3. **Fase 2 — navegação e estrutura:** não iniciada; o próximo bloco é `V7-PREP`, somente leitura e planejamento. V7 permanece pendente no projeto atual, usando `js/nav-shared.js` como base única; `V7-EXEC` não está autorizado; V6 permanece pendente e deve ser reavaliado depois.
...
- O próximo bloco aprovado é `V7-PREP`, somente leitura e planejamento. V7-EXEC não foi iniciado nem autorizado; V6 e B3 permanecem pendentes.
...
- V7-PREP — próximo bloco aprovado, somente leitura e planejamento; V7-EXEC não autorizado.
- V7 — unificação da navegação, alto risco, permanece pendente e não foi iniciada.
