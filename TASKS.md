...
- V5C2 — higiene e rotação editorial dos cards; decidir se o card mais antigo deve ser substituído e definir política de atualização da home em relação a `noticias.html`; risco médio; exige decisão humana item por item.
