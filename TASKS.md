...
**Separação aprovada:** R1 extraiu somente a lógica da grade "Acontece em breve" para `js/home-eventos.js`; R2 extraiu somente o carrossel de experiências para `js/home-experiencias.js`. A extração do R2 foi 1:1, sem mudança visual ou funcional, e não alterou R1. R3 é o próximo microbloco, destinado ao formulário; R4 acessibilidade/utilitários e R5 i18n/fallback inline permanecem posteriores.
...
**Aprendizado para R3–R5:** manter as fronteiras dos módulos explícitas; R3 formulário é o próximo módulo e não deve ser iniciado automaticamente. R4 acessibilidade/utilitários visuais permanece inline e R5 i18n/fallback inline deve ser o último e mais sensível.
